...
with open('files/obama_speech.txt','w') as f:
...
with open('files/obama_speech.txt','r') as f:
    text_obama = f.read()

with open('files/donald_speech.txt','w') as f:
    f.write('''Chief Justice Roberts, President Carter, President Clinton,President Bush, fellow Americans and people of the world – thank you.
...
with open('files/donald_speech.txt','r') as f:
    text_donald = f.read()

with open('files/melina_trump_speech.txt','w') as f:
    f.write('''Thank you very much. Thank you. You have all been very kind to Donald and me, to our young son Barron, and to our whole family. It's a very nice welcome and we're excited to be with you at this historic convention. I am so proud of your choice for president of the United States, my husband, Donald J. Trump.
...
with open('files/melina_trump_speech.txt','r') as f:
    text_melina = f.read()

with open('files/michelle_speech.txt','w') as f:
    f.write('''As you might imagine, for Barack, running for president is nothing compared to that first game of basketball with my brother, Craig.
...
Thank you, God bless you, and God bless America.''')
with open('files/michelle_speech.txt','r') as f:
    text_michelle = f.read()
...
print(num_of_lines_and_words(text_obama))
print(num_of_lines_and_words(text_donald))
print(num_of_lines_and_words(text_melina))
print(num_of_lines_and_words(text_michelle))
...
with open('files/countries_data.json','r') as f:
    # Não usar f.read pq o python le todo o dicionário como uma grande string 
    # json.load faz com que o python leia uma estrutura organizada onde voce pode acessar os dados
    countries_data = json.load(f)

def most_spoken_languages(filename, n):
    most_spoken = {}
    for country in filename:
            ...
            if key == 'languages':
                for language in value:
                    if language not in most_spoken:
                        ...
                        most_spoken[language] += 1
    most_spoken = sorted(most_spoken.items(), key=lambda kv:kv[1], reverse=True)[:n]
    return most_spoken
...
def most_populated_countries(filename,n):
    ...
    for country in filename:
        for key, value in country.items():
            ...
            if key == 'name':
                most_populated[value] = population
                
    most_populated = sorted(most_populated.items(), key=lambda kv:kv[1], reverse= True)[:n]

    for name, population in most_populated:
        new_dict = {'country':name,'population': population}
